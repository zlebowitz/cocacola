...
<div style="background: #8b7da7;">
  <p style="background: #20a5de; font-weight: 300; color: #fff; padding: 15px 0; font-size: 20px;"><span style="font-weight: 400;">Start Date:</span> 06-21-2016 | <span style="font-weight: 400;">End Date:</span> TBD </p>
</div>
...
<div style="width: 100%; clear: both; float: left; padding-top: 40px; padding-bottom: 40px;">
  <div style="width: 85%; margin: auto;">
    ...
    <div style="padding-left: 20px;float:left; width: 50%;">
      <img style="border-radius: 50%; width: 100px; float:left;" src="http://wwwstatic.lookercdn.com/people/team/doug_berscak_v0001.jpg">
      <div style="float:left; text-align: left; padding-left: 15px; padding-top: 15px;">
        ...
        <span style="font-weight: 300;">Doug Berscak<br> 
        doug@looker.com</span></p> 
      </div>
    </div>
    
    <div style="padding-left: 40px;float:left; width: 50%;">
      <img style="border-radius: 50%; width: 100px; float:left;" src="http://wwwstatic.lookercdn.com/people/team/zev_lebowitz_v0001.jpg">
      <div style="float:left; text-align: left; padding-left: 15px; padding-top: 15px;">
        <p><span style="font-size: 16px;">Analyst</span><br>
        <span style="font-weight: 300;">Zev Lebowitz<br> 
        zev@looker.com</span></p> 
      </div>
    </div>
